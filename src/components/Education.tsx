...
=======
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-950/50 border border-cyan-800/40 text-cyan-400 text-xs font-mono mb-3"
...
=======
            className="glass-panel rounded-3xl p-8 sm:p-10 border border-slate-800 shadow-2xl relative overflow-hidden group"
          >
            {/* Background Ambient Glow */}
            <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-br from-blue-600/10 via-purple-600/10 to-transparent rounded-full blur-3xl group-hover:scale-125 transition-transform duration-700 pointer-events-none" />

            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-slate-800">
              <div className="flex items-start gap-5">
                {/* Institution Icon Badge */}
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-blue-600 to-purple-600 p-[2px] flex-shrink-0 shadow-xl">
...
=======
                  ...
                  <p className="text-xs text-slate-400 flex items-center gap-3 font-mono">
                    <span className="flex items-center gap-1">
                      <Calendar className="w-3.5 h-3.5 text-purple-400" /> {PERSONAL_INFO.graduationYear}
                    </span>
                    <span className="flex items-center gap-1">
                      <MapPin className="w-3.5 h-3.5 text-cyan-400" /> Tamil Nadu, India
>>>>>>> 17a2389de4f74c8b871733a1d870939a78d9bd57
                    </span>
                  </p>
                </div>
...
=======
              <div className="p-4 rounded-2xl bg-slate-900/90 border border-slate-800 text-center flex-shrink-0 min-w-[140px] shadow-lg">
                <span className="text-xs font-mono text-slate-400 block mb-1">Cumulative CGPA</span>
...
=======
                <h4 className="text-sm font-bold text-white mb-4 flex items-center gap-2">
                  <BookOpen className="w-4 h-4 text-purple-400" /> Core Engineering Coursework
                </h4>
                <ul className="space-y-2.5 font-mono text-xs text-slate-300">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-blue-400" /> Object-Oriented Programming (Java)
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-blue-400" /> Data Structures & Algorithms
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-blue-400" /> Database Management Systems (DBMS & SQL)
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-blue-400" /> Artificial Intelligence & Machine Learning
>>>>>>> 17a2389de4f74c8b871733a1d870939a78d9bd57
                  </li>
                </ul>
              </div>
...
=======
                <h4 className="text-sm font-bold text-white mb-4 flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-cyan-400" /> Key Specializations
                </h4>
                <div className="space-y-2 text-xs text-slate-300">
                  <div className="p-3 rounded-xl bg-slate-900/70 border border-slate-800">
                    <strong className="text-cyan-300 block mb-0.5">Generative AI & LLMs:</strong>
                    Building RAG pipelines, FAISS vector indexing, and embedding optimization.
                  </div>
                  <div className="p-3 rounded-xl bg-slate-900/70 border border-slate-800">
                    <strong className="text-purple-300 block mb-0.5">Backend Development:</strong>
>>>>>>> 17a2389de4f74c8b871733a1d870939a78d9bd57

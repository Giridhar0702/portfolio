    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-4xl glass-panel rounded-3xl border border-slate-200 dark:border-slate-700 shadow-2xl overflow-hidden my-6 bg-white dark:bg-[#0B1120] text-slate-900 dark:text-slate-100 cursor-default"
        >
          {/* Top Bar Actions */}
